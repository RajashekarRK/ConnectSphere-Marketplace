...
// FIX: Added PerformanceAlert type import
import { PerformanceAlert } from '../../types.ts';
...
const SystemPerformancePage: React.FC<SystemPerformancePageProps> = ({ alerts }) => {
  return (
    <div className="bg-white rounded-xl shadow-lg p-6 sm:p-10 max-w-4xl mx-auto animate-fade-in text-center">
      ...
      <div className="space-y-6 text-slate-600 leading-relaxed">
        <p>This page is a placeholder for future content related to system performance metrics, such as API latency, server load, and database performance.</p>
      </div>
       <style>{`
        @keyframes fade-in {
